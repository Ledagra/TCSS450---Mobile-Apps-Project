package edu.uw.team8project.services;
...
import edu.uw.team8project.AuthActivity;
import edu.uw.team8project.R;
import edu.uw.team8project.ui.messages.ChatMessage;
...
public class PushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int chatId = -1;
        try{
            Log.i("RECIVER", "Made to try");

            message = ChatMessage.createFromJsonString(intent.getStringExtra("message"));
            chatId = intent.getIntExtra("chatid", -1);
        } catch (JSONException e) {
            //Web service sent me something unexpected...I can't deal with this.
