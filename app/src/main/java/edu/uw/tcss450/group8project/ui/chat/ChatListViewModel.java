            ...
            if (root.has(getString.apply(R.string.keys_json_chat_success))) {
                ...
                if (root.has(getString.apply(R.string.keys_json_chat_previews))) {
                    ...
                    for(int i = 0; i < previewsJSON.length(); i++) {
                        ...
                        ChatPreview post = new ChatPreview.Builder(
                                jsonChat.getString(
                                        getString.apply(
