...
public final class ChatMessages implements Serializable {
    ...
    public ChatMessages(int messageId, String message, String sender, String timeStamp) {
     ...
     */
    public static ChatMessages createFromJsonString(final String cmAsJson) throws JSONException {
        final JSONObject msg = new JSONObject(cmAsJson);
        return new ChatMessages(msg.getInt("messageid"),
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other instanceof ChatMessages) {
            result = mMessageId == ((ChatMessages) other).mMessageId;
        }
        return result;
    }
}
