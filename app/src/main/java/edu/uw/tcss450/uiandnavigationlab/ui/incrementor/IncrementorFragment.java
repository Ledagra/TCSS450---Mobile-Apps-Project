...
public class IncrementorFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Obtain acces to the ViewModel. If this fragment object is new, the ViewModel
        //will be recreated. Note the parameter to the ViewModelProvider constructor - this.
        IncrementorViewModel model =
                new ViewModelProvider(getActivity()).get(IncrementorViewModel.class);

        //Add an observer to the MutableLiveData -mCount.
