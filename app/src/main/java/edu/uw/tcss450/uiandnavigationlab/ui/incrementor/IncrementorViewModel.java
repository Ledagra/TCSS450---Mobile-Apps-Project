...
public class IncrementorViewModel extends ViewModel {
    ...
    /**
     * No-arg constructor that initializes this object. Do not explicitly call this.
     */
    ...
    /**
     * Add an observer to this live data. This is a pass through method for this class's
     * MutableLiveData field mCount
     *
     * See LiveData.observe for more implementation details.
     * @param owner of the LifecycleOwner which controls the observer.
